...
class UserModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        u1 = User.signup("Zack94", "princessclemmons@yahoo.com", "Mildredk29", None)
        uid1 = 1111
        u1.id = uid1

        u2 = User.signup("nita94", "nitacbrown@gmail.com", "Rogeram25", None)
        uid2 = 2222
        u2.id = uid2
    ...
    def test_user_model(self):
        ...
        u = User(
            email="nitacbrown@gmail.com",
            username="nitacbrown@gmail.com",
            password="Rogeram25"
        )
